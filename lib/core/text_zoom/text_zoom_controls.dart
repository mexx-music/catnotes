    ...
    return Shortcuts(
      ...
      child: Actions(
        actions: <Type, Action<Intent>>{
          IncreaseTextSizeIntent: CallbackAction<IncreaseTextSizeIntent>(
            onInvoke: (_) {
              controller.increase();
              return null;
            },
          ),
          DecreaseTextSizeIntent: CallbackAction<DecreaseTextSizeIntent>(
            onInvoke: (_) {
              controller.decrease();
              return null;
            },
